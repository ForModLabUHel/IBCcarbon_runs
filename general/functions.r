...
create_prebas_input.f = function(r_no, clim, data.sample, nYears, startingYear=0,domSPrun=0) { # dat = climscendataset
  ...
  if(domSPrun==1){
    ...
    if(TRUE){ #### if true will vary H and D of pine and spruce using siteType
      ...
      data.sample[pine>0. & spruce >0. & fert<2.5 & dbhP<0.5,dbhSP:=((ba-(0.5/dbh)*baP-baB)/baSP)*dbh]
      ...
      data.sample[pine>0. & spruce >0. & fert<2.5 & X==minDelta,hSP:=h*(ba-minDdelta* baP-baB)/baSP]
      data.sample[pine>0. & spruce >0. & fert<2.5, hP:=X*h]
      data.sample[pine>0. & spruce >0. & fert<2.5 & hP<1.5,hSP:=((ba-(1.5/h)*baP-baB)/baSP)*h]
      ...
      data.sample[pine>0. & spruce >0. & fert==3 & dbhP<0.5,dbhSP:=((ba-(0.5/dbh)*baP-baB)/baSP)*dbh]
      ...
      data.sample[pine>0. & spruce >0. & fert==3 & X==minDelta,hSP:=h*(ba-minDdelta* baP-baB)/baSP]
      ...
      data.sample[pine>0. & spruce >0. & fert>3.5, X:=pmax(minDelta,(ba-1.1*baSP-baB)/baP)]
      ...
      data.sample[pine>0. & spruce >0. & fert>3.5 & dbhSP<0.5,dbhP:=((ba-(0.5/dbh)*baSP-baB)/baP)*dbh]
      ...
      data.sample[pine>0. & spruce >0. & fert>3.5 & hSP<1.5,hP:=((ba-(1.5/h)*baSP-baB)/baP)*h]
