...
harvestscenarios = c("Low","MaxSust","NoHarv")#c("Base","Low","MaxSust") #c("Low","MaxSust")#Base"#Low"#c("MaxSust", "Base","NoHarv") ## noharv must be the last element otherwise cons area are ignored
